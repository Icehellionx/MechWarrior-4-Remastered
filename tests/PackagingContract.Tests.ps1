...
Assert-True ($build -match 'a126cd326ba1e9e96ebedcb7921c535d546933febccf6d7c3b68149a885da90b') 'Package staging must exact-hash the reviewed MW4 dgVoodoo profile.'
