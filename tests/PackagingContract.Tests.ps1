...
Assert-True ($inno -match 'StatusMsg:\s*"Choose original media and install games\.\.\."' -and $inno -match 'skipifsilent') 'Interactive setup must run original-media intake as a required setup stage.'
