...
Assert-True ($build -match 'ddraw-upstream\.dll' -and $build -match 'f75f0ac48d2782f225c483dc2f1142303a513e8dd8a60793891ade89f64755ea') 'Package must exact-hash the clean upstream Mercenaries presentation DLL.'
Assert-True ($build -match 'DDrawCompat-MW4Mercs\.ini' -and $build -match 'DDrawCompat-upstream-source-2c9a07fdf9308e2b0b117886a7e363b149ee1bc7\.zip') 'Package must retain the title-specific Mercenaries profile and corresponding upstream source.'
