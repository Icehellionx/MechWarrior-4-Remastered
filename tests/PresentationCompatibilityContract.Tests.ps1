...
Assert-True ($lifecycle -match 'Covers\(windowRect, monitorRect\)\) return monitorRect' -and $lifecycle -notmatch 'Covers\(windowRect, monitorRect\)\) return windowRect') 'The lifecycle guard must pin physical monitor bounds once borderless desktop presentation stabilizes; oversized dgVoodoo rectangles crop ultrawide displays.'
