...
- The launcher now embeds a project-owned transparent MW4-inspired icon: a simplified gunmetal/amber heavy-mech and integrated `4` with a distinct lower-right `R`. The selected RGBA master and Windows icon live in `assets/branding/` with prompt/provenance notes.
