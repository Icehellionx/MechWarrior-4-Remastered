...
- Public release: none.
- Internal setup `0.6.19` is the first candidate with the 13-entry Vengeance InstallShield filename map and verified-tree migration. Exact setup SHA-256 is `8f010305d46676f82e8b64bae1aa6a358a9e47d9ce8dfdc77464262788eff27c`; release-tree policy passed and Defender engine `1.1.26080.3`, intelligence `1.459.256.0`, found no threat/new detection. It remains a field candidate until Vengeance and Black Knight cross their intro-to-menu boundary and complete Alt-Tab, pilot, mission, repair, and uninstall checks.
