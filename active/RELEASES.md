...
- Public release: none.
- Product source/build: internal candidate `0.6.9` adds setup-owned required graphics configuration for every ready title, a 1920×1080 fullscreen launch candidate, and a topmost Inno wizard to the successful `0.6.7` installation/menu baseline. Pilot creation, fullscreen/focus polish, unified uninstall, and gameplay still require field acceptance. Internal candidates through `0.6.8` are superseded and must not be distributed.
