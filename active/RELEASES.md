...
- Public release: none.
- Product source/build: internal `0.5.7` and `0.6.1` are invalid and must not be distributed. Internal candidate `0.6.3` compiles with the corrected page lifecycle, verified Black Knight PR1 runtime, explicit retail rejection, and fresh Mercenaries worker/runtime evidence, but still requires elevated packaged media-flow/uninstall and interactive menu/gameplay acceptance before distribution. Internal `0.6.2` is superseded.
...
- Packaging: pinned Inno Setup 7.1.0 built internal `0.6.3` (166,380,972 bytes) SHA-256 `b88ab88362a58588f51b86433919806bdb1e36e73b8f9acae6cd0dae867e5d88`. It remains internal until the complete elevated media-first setup, repair, unified uninstall, and dialog-aware three-game acceptance path passes.
- Antivirus: the hosted Black Knight runtime, fresh complete Vengeance/Black Knight/Inner Sphere and Mercenaries PR1 installed trees, staged application payload, and exact `0.6.3` setup passed Defender engine `1.1.26080.3`, intelligence `1.459.239.0`, with no new detection/remediation event. Signing/SmartScreen reputation, repair UI, wider hardware, joystick compatibility, and in-game pack visibility remain open.
