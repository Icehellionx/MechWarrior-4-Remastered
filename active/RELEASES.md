...
- Public release: none.
- Internal field candidate `0.6.21` packages Black Knight static v4. Setup is 172,859,562 bytes, SHA-256 `25648ffc9bd0ed8f8384cbdac4d8209018b95b226c432be802ade52b64bf4bec`. Two clean 21-file payload stages were byte-identical; release-tree policy passed. The exact setup, unpacked payload, and v4 Vengeance-family coordinator tree produced zero matching Defender detections under engine `1.1.26080.3`, intelligence `1.459.256.0`, with real-time protection enabled. It remains internal pending focused Black Knight intro/menu/Alt-Tab/pilot/mission and packaged repair/uninstall.
