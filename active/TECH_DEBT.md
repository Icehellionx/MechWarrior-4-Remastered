...
18. Black Knight's injected-helper instability is resolved by normal app-local DLL loading plus a narrow signature-checked OEP patch, with the verified Vengeance base composed during setup. Three consecutive final-tree launches were single-process, responsive, and log-clean. Remaining debt is gameplay/save/audio/input and broader hardware qualification; DDrawCompat remains rejected rather than stacked onto this boundary.
