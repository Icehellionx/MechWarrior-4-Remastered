...
| Black Knight Disc 1, `45.05.10.0701` | Integrated SafeDisc 2.30-era executable; original SHA-256 `fa62e84b64a8ad2758b4d12213873d84b0004107176499d195f70e2bdaf3d6b7` | Original ISO executable plus source-built SafeDiscLoader2 DLL and project-owned non-elevating helper | **Disc-free process launch passed**: helper exit 0, responsive window titled `MechWarrior Black Knight` after 10 seconds, no mounted ISO and no UAC; current Defender found no threats in the full disposable tree | Reproducibly build pinned GPL source; verify menu/gameplay/config/save; stage helper/DLL through owned install plan; scan final package/install tree |
